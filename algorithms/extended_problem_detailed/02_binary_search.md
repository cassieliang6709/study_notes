...
`Search in Rotated Sorted Array` 的核心是先识别它最像哪种经典题型，再把题目翻译成那个模板。
...
`Find Peak Element` 的核心是先识别它最像哪种经典题型，再把题目翻译成那个模板。
...
`Single Element in a Sorted Array` 的核心是先识别它最像哪种经典题型，再把题目翻译成那个模板。
...
`Search a 2D Matrix` 的核心是先识别它最像哪种经典题型，再把题目翻译成那个模板。
...
`Find Minimum in Rotated Sorted Array` 的核心是先识别它最像哪种经典题型，再把题目翻译成那个模板。
...
`Kth Smallest Element in a Sorted Matrix` 的核心是先识别它最像哪种经典题型，再把题目翻译成那个模板。
...
`Random Pick with Weight` 的核心是先识别它最像哪种经典题型，再把题目翻译成那个模板。
